...
import com.damaba.damaba.logger.Logger
...
class SecurityConfig(private val env: Environment) {
    companion object {
        ...
        val AUTH_WHITE_LIST = mapOf(
            ...
            "/api/v*/region-clusters" to HttpMethod.GET,
            "/api/v*/photographers/{photographerId:\\d+}" to HttpMethod.GET,
            "/api/v*/photographers/{photographerId:\\d+}/details" to HttpMethod.GET,
            "/api/v*/photographers/list" to HttpMethod.GET,
