...
class UpdatePromotionUseCaseCommandTest {
    @ParameterizedTest
    ...
    fun `이미지 개수가 유효하지 않으면 ValidationException이 발생한다`(images: List<Image>) {
